...
public class PomodoroPreferences extends PreferenceActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fillInValue(pref,
				String.valueOf(mPrefs.getInt(Pomodoro.PREF_TOMATO_DELAY,
